<?php 
	trait ProductsModel{
		...
		public function modelUpdate($id){
			...
			$conn->query("update products set name='$name',description='$description',content='$content',hot=$hot,price=$price,giamoi = $giamoi,discount=$discount,category_id=$category_id,size1='$size1',size2='$size2',size3='$size3',size4='$size4',size5='$size5' where id=$id");
		...
		public function modelCreate(){
			...
			$conn = Connection::getInstance();
			//update du lieu tuong ung voi id truyen vao
			$conn->query("insert into products set name='$name',description='$description',content='$content',hot=$hot,photo='$photo',photo1='$photo1',photo2='$photo2',photo3='$photo3',photo4='$photo4',photo5='$photo5',price=$price,giamoi = $giamoi,discount=$discount,category_id=$category_id,size1='$size1',size2='$size2',size3='$size3',size4='$size4',size5='$size5'");
		}
		//xoa ban ghi
