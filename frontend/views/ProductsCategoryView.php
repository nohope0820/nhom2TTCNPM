...
<!-- paging -->
                <div style="margin-top: 50px; position:absolute; bottom: -1730px;"  class="">
                   <ul class="pagination" style="font-weight: bold;">
                    ...
                    <li class="page-item"><a class="page-link" href="index.php?controller=products&action=category&id=<?php echo $category_id; ?>&p=<?php echo $i; ?>" style="text-decoration: none; color: black;"><?php echo $i; ?></a></li>
                    <?php endfor; ?>
                  </ul>
                </div>
                <!-- end paging --> 