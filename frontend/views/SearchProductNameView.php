...
<!-- content_search -->
   ...
   <?php 
      ...
      <li>
        <a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>&star=5"><img src="../assets/upload/products/<?php echo $rows->photo; ?>" style="width: 185px; height: 185px;"></a>
        <div class="ctsp">
      ...
      <div><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id;?>&star=5" style="border: 1px solid green; border-radius: 10px; padding: 6px; text-decoration: none; color: white; background: green; margin-left: 47px;">Xem chi tiết</a></div>
        </a></li>
        <?php endforeach; ?>
      </ul>
<style type="text/css">
...
margin-right: 10px;}
                ...
                <div style="margin-top: 10px; position:absolute; bottom: -1730px;"  class="&#x70;&#x61;&#x67;&#x69;&#x6E;&#x61;&#x74;&#x69;&#x6F;&#x6E;&#x2D;&#x63;&#x6F;&#x6E;&#x74;&#x61;&#x69;&#x6E;&#x65;&#x72;">
                  <ul class="pagination" style="font-weight: bold;">
                    ...
                    <li class="page-item"><a class="page-link" href="index.php?controller=search&action=productName&key=<?php echo $key; ?>&p=<?php echo $i; ?>" style="text-decoration: none; color: black;"><?php echo $i; ?></a></li>
                    <?php endfor; ?>
                  </ul>
                </div>
